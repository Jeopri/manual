...
const items: Experience[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "Implemented client-side form validation and error handling to ensure data integrity and provide clear user feedback across all input forms.",
      "Optimized page load performance and rendering by applying lazy loading, code splitting, and efficient state management practices.",
      "Collaborated closely with the design team to translate UI mockups into accurate, pixel-perfect React components.",
      "Conducted cross-browser testing and debugging to ensure consistent behavior and appearance across different environments.",
    ],
    group: "work",
  },
